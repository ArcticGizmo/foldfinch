...
namespace Foldfinch.Core.Changelog;
...
public static class ChangelogParser
{
    ...
    /// <paramref name="lastSeen"/> is null/blank/unparseable or equals <paramref name="current"/>.
    /// Unversioned sections are never included.
    /// </summary>
    public static IReadOnlyList<ChangelogSection> UnseenSince(string markdown, string? lastSeen, string current)
    {
        ...
        _ = TryParse(current, out var high);
